...
</script>async const response = await apiClient.get('/patients');
if (response.data.success) {
this.patients = response.data.data;
}async const response = await apiClient.get('/doctors');
if (response.data.success) {
this.doctors = response.data.data;
}async const response = await apiClient.get('/appointments');
if (response.data.success) {
...
}async const response = await apiClient.get('/patients');
if (response.data.success) {
this.patients = response.data.data;
}async const response = await apiClient.get('/doctors');
if (response.data.success) {
